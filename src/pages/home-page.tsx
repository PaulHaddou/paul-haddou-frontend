    ...
    <HomeLayout>
      <div className="box-border flex h-screen w-screen flex-col overflow-hidden bg-primary-beige p-40 md:p-[150px]">
        <div className="relative flex h-full w-full flex-col items-center justify-center">
          <span className="absolute right-0 top-0 h-full w-2 bg-homeBorderX" />
          <span className="absolute left-0 top-0 h-full w-2 bg-homeBorderX" />
          <span className="absolute right-0 top-0 h-2 w-full bg-homeBorderY" />
          <span className="absolute bottom-0 right-0 h-2 w-full bg-homeBorderY" />
